// @(#)root/proofplayer:$Id: TProofDraw.cxx 48046 2012-12-14 15:35:16Z rdm $
...
#  define TH1CANNOTEXTEND ResetBit(TH1::kCanRebin)
#  define TH1CANEXTENDALL TestBit(TH1::kCanRebin)
#endif
...
//            hist->SetDirectory(0);
      ...
      if (hist->TH1CANEXTENDALL && hist->TestBit(kCanDelete)) {
