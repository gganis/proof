...
set(rootcint_cmd ${ROOT_ROOT_DIR}/bin/rootcint)   
set(rlibmap_cmd ${ROOT_ROOT_DIR}/bin/rlibmap)   
...
#---------------------------------------------------------------------------------------------------
#---ROOT_GET_SOURCES( <variable> <sources> ...)
#---------------------------------------------------------------------------------------------------
function(ROOT_GET_SOURCES variable )
  set(sources)
  foreach( fp ${ARGN})  
    if( IS_ABSOLUTE ${fp}) 
      file(GLOB files ${fp})
...
function(ROOT_GENERATE_DICTIONARY dictionary)
  ...
  endforeach()
  string(REPLACE "${CMAKE_CURRENT_SOURCE_DIR}/" ""  rheaderfiles "${headerfiles}")
...
function(ROOT_LINKER_LIBRARY library)
  ...
  ROOT_GET_SOURCES(lib_srcs ${ARG_DEFAULT_ARGS})
  if(NOT ARG_TYPE)
    set(ARG_TYPE SHARED)
  endif()
...
function(ROOT_MODULE_LIBRARY library)
  ...
  ROOT_GET_SOURCES(lib_srcs ${ARG_DEFAULT_ARGS})
  include_directories(BEFORE ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_BINARY_DIR}/include )
  add_library( ${library} SHARED ${lib_srcs})
  set_target_properties(${library}  PROPERTIES ${ROOT_LIBRARY_PROPERTIES})
  target_link_libraries(${library} ${ARG_LIBRARIES})
  #----Installation details-------------------------------------------------------
...
function(ROOT_EXECUTABLE executable)
  ...
  ROOT_GET_SOURCES(exe_srcs ${ARG_DEFAULT_ARGS})
